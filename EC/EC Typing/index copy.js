...
*/
document.body.style.background = "url(https://66.media.tumblr.com/c1df4bc70135a05bf8290c638c32c09c/tumblr_p0xq7rLfBu1vbdodoo1_500.gif)";
...
function insertWordOnPage(word, x, y){
  ...
  a.style.top = y + "px";
  a.style.color = "white";
  a.style.fontFamily = "Impact,Charcoal,sans-serif";
